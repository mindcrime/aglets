...
Serializable {
	...
	private final boolean[] _actionFlag = new boolean[NUMBER_OF_ACTIONS];

	// should be implemented?
	// ==== public PermissionCollection newPermissionCollection();
	public PlainAgletPermission(final String name, final String actions) {
		super(name);
	...
	public boolean equals(final Object obj) {
		...
		final PlainAgletPermission o = (PlainAgletPermission) obj;
	...
	public boolean implies(final Permission p) {
		...
		final PlainAgletPermission ap = (PlainAgletPermission) p;
