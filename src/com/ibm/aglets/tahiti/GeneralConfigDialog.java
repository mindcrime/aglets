...
final class GeneralConfigDialog extends TahitiDialog 
	...
	private GeneralConfigDialog(MainWindow parentFrame) {
	    ...
	    JButton cacheButton = JComponentBuilder.createJButton(this.baseKey + ".cacheButton", 
		                                                  GUICommandStrings.CLEAR_CACHE_COMMAND,
		                                                  this);
	    cachePanel.add(cacheButton);
	    TitledBorder border = new TitledBorder(JComponentBuilder.getTitle(this.baseKey + ".cache"));
	    ...
	    this.startUpAgent = new JCheckBox(this.translator.translate( this.baseKey + ".startupAgent") );
	    ...
	    border = new TitledBorder(JComponentBuilder.getTitle(this.baseKey + ".startupAgent"));
	    border.setTitleJustification(TitledBorder.CENTER);
	    border.setTitleColor(Color.BLUE);
	...
	public void actionPerformed(ActionEvent event) {
	    ...
	    if( GUICommandStrings.CLEAR_CACHE_COMMAND.equals(command)){
	...
	/**
	 * Enables or disables the startup agent text field depending on the selection
	 * of the "launch at the startup" checkbox.
	 *
	 */
	...
	private void save() {
	    ...
	    tahiti_res.setResource("tahiti.startup", 
		    String.valueOf(this.startUpAgent.isSelected()));
	    tahiti_res.setResource("tahiti.startupAglets", 
		    this.startUpAgentClass.getText());
