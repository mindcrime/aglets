...
public class TahitiBrowser extends TahitiDialog implements Runnable {
         ...
         * @param mainWindow the window owner of this dialog
         * @param fileName the file name to set for the browser
         */
        public TahitiBrowser(TahitiWindow mainWindow, String fileName)
        {
    		...
    		JOptionPane.showMessageDialog(this,
       		                              translator.translate( baseKey + ".URLError.title"),
       		                              translator.translate( baseKey + ".URLError"),
         ...
         * @param mainWindow the owner of this dialog
         * @param webPage the main web page from which to start
         */
         ...
         */
         protected void showPage() {
        	 ...
        	 editorPanel.setContentType("text/html");	// show only text/html content type
        	 editorPanel.setEditorKit(kit);		// associate the editor panel and the HTML editor

        	 
        	 editorPanel.setPage( this.mainPage );							// show the file
        	 editorPanel.setEditable(false);						// do not allow the content to be changed by the user
        	 ...
        	 editorPanel.addHyperlinkListener(
        		 new  HyperlinkListener(){
        			 ...
        			 try {
        			     ...
        			     AgletsTranslator translator = getAgletsTranslator();
        	 ...
        	 this.setTitle(this.getTitle()+" - "+editorPanel.getPage().toExternalForm());
