...
class Util {
	...
	public static void setBackground(final Component cmp) {
		backgrounds.addElement(cmp);
		cmp.setBackground(getBackground());
	}

	public static void setFixedFont(final Component cmp) {
	...
	public static void setFont(final Component cmp) {
	...
	public static void setTitleFont(final Component cmp) {
