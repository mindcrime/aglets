...
final class NetworkConfigDialog extends TahitiDialog 
	...
	private NetworkConfigDialog(MainWindow parent) {
	    ...
	    this.httpTunneling = JComponentBuilder.createJCheckBox( this.baseKey + ".httpTunneling",
		                                                     false, this);
	    this.useProxy = JComponentBuilder.createJCheckBox( this.baseKey + ".useProxy", 
		    						     false, this);
	    this.proxyHost = JComponentBuilder.createJTextField(20, null, this.baseKey + ".proxyHost");
	    this.proxyPort = JComponentBuilder.createJTextField(6, null, this.baseKey + ".proxyPort");
	    this.noProxy = JComponentBuilder.createJTextField(30, null, this.baseKey + ".noProxy");
	    ...
	    TitledBorder border = new TitledBorder( JComponentBuilder.getTitle( this.baseKey + ".httpPanel") );
	    ...
	    this.atpAuthentication = JComponentBuilder.createJCheckBox( this.baseKey + ".authenticationMode", false, this);
	    this.useSecureRandomSeed = JComponentBuilder.createJCheckBox( this.baseKey + ".secureRandomSeed", false, this);
	    
	    JPanel buttonPanel = new JPanel();
	    buttonPanel.setLayout( new GridLayout(2,2) );
	    this.createSharedSecretButton = JComponentBuilder.createJButton( this.baseKey + ".createSharedSecret", 
		                                                        GUICommandStrings.CREATE_SHARED_SECRET_COMMAND,
		                                                        this);
	    this.removeSharedSecretButton = JComponentBuilder.createJButton( this.baseKey + ".removeSharedSecret", 
		                                                        GUICommandStrings.REMOVE_SHARED_SECRET_COMMAND,
		                                                        this);
	    this.importSharedSecretButton = JComponentBuilder.createJButton( this.baseKey + ".importSharedSecret",
		                                                        GUICommandStrings.IMPORT_SHARED_SECRET_COMMAND,
		                                                        this);
	    this.exportSharedSecretButton = JComponentBuilder.createJButton( this.baseKey + ".exportSharedSecret",
		                                                        GUICommandStrings.EXPORT_SHARED_SECRET_COMMAND,
		                                                        this);
	    ...
	    TitledBorder border3 = new TitledBorder( JComponentBuilder.getTitle( this.baseKey + ".authPanel") );
	    ...
	    this.httpMessaging = JComponentBuilder.createJCheckBox( this.baseKey + ".httpMessaging", false, this);
	    otherPanel.add(this.httpMessaging);
	    TitledBorder border2 = new TitledBorder( JComponentBuilder.getTitle(this.baseKey + ".otherPanel") );
	...
	public void actionPerformed(ActionEvent event) {
	    ...
	    if( GUICommandStrings.EXPORT_SHARED_SECRET_COMMAND.equals(command))
		this.exportSharedSecret();
	    else
	    if( GUICommandStrings.IMPORT_SHARED_SECRET_COMMAND.equals(command))
		this.importSharedSecret();
	    else
	    if( GUICommandStrings.CREATE_SHARED_SECRET_COMMAND.equals(command))
		this.createSharedSecret();
	    else
	    if( GUICommandStrings.REMOVE_SHARED_SECRET_COMMAND.equals(command))
	...
	/**
	 * Loads values from the aglet resources and enables/disables the gui components
	 *
	 */
