...
public class AgletListPanel<ITEM> extends JPanel {
    ...
    /**
     * Default constructor. Creates a ScrollPane and a list model and place the jlist in
     * this panel.
     *
     */
    ...
    /**
     * Constructor with a parent element, used to get the size of the list automatically.
     ...
     * @param elements the number of elements the list will show
     * 
     */
     ...
     * @param toAdd the parameter to add to the list
     *
     */
     ...
     * @param index the index to which the element must be placed
     *
     */
	...
	for(int i=0; i< selected.length; i++ )
	    selectedItems.add( (ITEM) this.getItem(i) );
	...
	if( item == null || (!( this.listModel.contains(item))) )
		...
		ITEM element = (ITEM) elements.nextElement();
     ...
     * @param firstIndex the index of the first element to move
     * @param secondIndex the element of the second index to move
     *
     */
     ...
     * @param newItem the new item to place in the list
     * @param index the index to which the item must be placed.
     *
     *
     */
    ...
    /**
     * Get all the available elements in the list, without regard to the selection.
     ...
     * @param index the index to emphasize
     *
     */
     ...
     * @param foregroung the foreground color
     */
     ...
     * @param value the (translated) value of the border
     */
