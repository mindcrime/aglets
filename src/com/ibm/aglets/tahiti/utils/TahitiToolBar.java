...
public class TahitiToolBar extends JToolBar implements ActionListener {
	...
	public TahitiToolBar(final ActionListener listener) {
		...
		shrink = new JButton("", IconRepository.getIcon("reduce_window"));
		shrink.setActionCommand(TahitiCommandStrings.REDUCE_WINDOW_COMMAND);
		shrink.addActionListener(listener);
		shrink.addActionListener(this);
		shrink.setToolTipText(bundle.getString("button.reduce.tooltip"));
		this.add(shrink);

		final JButton create = new JButton(bundle.getString("button.create"), IconRepository.getIcon("create"));
		...
		final JButton clone = new JButton(bundle.getString("button.clone"), IconRepository.getIcon("clone"));
		...
		final JButton dispose = new JButton(bundle.getString("button.dispose"), IconRepository.getIcon("dispose"));
		...
		final JButton dispatch = new JButton(bundle.getString("button.dispatch"), IconRepository.getIcon("dispatch"));
		...
		final JButton retract = new JButton(bundle.getString("button.retract"), IconRepository.getIcon("retract"));
		...
		final JButton activate = new JButton(bundle.getString("button.activate"), IconRepository.getIcon("activate"));
		...
		final JButton deactivate = new JButton(bundle.getString("button.deactivate"), IconRepository.getIcon("deactivate"));
		...
		final JButton sleep = new JButton(bundle.getString("button.sleep"), IconRepository.getIcon("sleep"));
		...
		final JButton dialog = new JButton(bundle.getString("button.dialog"), IconRepository.getIcon("dialog"));
		...
		final JButton info = new JButton(bundle.getString("button.info"), IconRepository.getIcon("info"));
	...
	public void actionPerformed(final ActionEvent event) {
		...
		if ((command != null)
			...
			shrink.setIcon(IconRepository.getIcon("enlarge_window"));
			shrink.setActionCommand(TahitiCommandStrings.ENLARGE_WINDOW_COMMAND);
			shrink.setToolTipText(bundle.getString("button.enlarge.tooltip"));
		} else if ((command != null)
				&& command.equals(TahitiCommandStrings.ENLARGE_WINDOW_COMMAND)) {
			shrink.setIcon(IconRepository.getIcon("reduce_window"));
			shrink.setActionCommand(TahitiCommandStrings.REDUCE_WINDOW_COMMAND);
			shrink.setToolTipText(bundle.getString("button.reduce.tooltip"));
		}
	}
