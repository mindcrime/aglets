...
/**
 * A window that is able to show both text and html files, and can be used to
 * show the javadoc documentation or web pages available on internet.
 */
public class DocumentationWindow extends JFrame implements Runnable {
    ...
    /**
     * Default constructor. It try to load the index.html file from the docs
     * default directory specified into the properties. If no directory is
     * founded then it ask to the user.
     * 
     * @param width
     ...
     *            the dimension
     * @param fileToRead
     *            a file to display. It can be a text file or an html file. If
     *            null the reader will work as a javadoc reader, else it will
     *            display the asked file.
     * @param title
     *            the title of the window
     */
    public DocumentationWindow(int width, int height, File fileToRead,
	    String title) {
	super(title);
     ...
     *            the dimension
     * @param url
     *            the page to display. It can be a text file or an html file. If
     *            null the reader will work as a javadoc reader, else it will
     *            display the asked file.
     * @param title
     *            the title of the window
