...
/**
 * A dialog that shows the general information about the project: the logo, the name, the version,
 * the credits and the licence.
...
public class AboutDialog extends BaseAgletsDialog {
	...
	this.licenceArea = JComponentBuilder.createJTextArea( this.translator.translate( this.baseKey + ".licenceFile" ) );
	...
	JButton closeButton = JComponentBuilder.createJButton( this.baseKey + ".okButton", 
		                                               GUICommandStrings.OK_COMMAND,
		                                               this);
     ...
     * @param parentFrame the frame parent of this dialog
