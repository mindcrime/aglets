...
public class URIEncoder {
	...
	public static String decode(final String str) {
		...
		final String encoding = Encoding.getDefault().getJavaEncoding();
	 ...
	 * @see java.net.URLEncoder
	 */
	public static String decode(final String str, final String encoding)
		...
		while (index < length) {
			...
			if (c == CHAR_PLUS) {
				...
				if (index >= length) {
					...
					final char c2 = str.charAt(index);
	 ...
	 */
	public static String encode(final byte[] sequence) {
	 ...
	 * @return the translated <code>String</code>.
	 */
	public static String encode(final String str, final String encoding)
	throws UnsupportedEncodingException {
		if (str == null) {
			return null;
		}
