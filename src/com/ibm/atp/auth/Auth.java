...
public abstract class Auth extends Object {
	...
	/**
	 * The turn of protocol. The first turn individual must be authenticated at
	 * first, and then the second turn individual must be authenticated.
	 */
	/**
	 ...
	 */
	protected Auth(final String name) {
	 ...
	 */
	protected String getTurnPad(final int turn) {
		String pad = null;
	 ...
	 *            the name of message digest function algorithm
	 */
	protected void setDigestAlgorithm(final String name) {
	 ...
	 */
	public void setFirstTurnIdentifier(final String id) {
		_idFirst = id;
	}
	 ...
	 */
	public void setSecondTurnIdentifier(final String id) {
		_idSecond = id;
	}
