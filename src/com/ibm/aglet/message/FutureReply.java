...
/**
 * The <tt>FutureReply</tt> class is a abstract class for the result of a future
 * message.
 * 
...
public abstract class FutureReply {
    ...
    /*
     * Informs that this result is added to ReplySet object. This is not
     * normally used by the aglet programmers.
     */
     ...
     */
    public boolean getBooleanReply() throws MessageException,
	    NotHandledException {
	...
	return ((Character) this.getReply()).charValue();
    }
	...
	return ((Number) this.getReply()).doubleValue();
    }
	...
	return ((Number) this.getReply()).floatValue();
    }
	...
	return ((Number) this.getReply()).intValue();
    }
	...
	return ((Number) this.getReply()).longValue();
    }

    /**
     * If the message was not handled the receiver, MessageNotHandled exception
     * is raised.
     * 
     ...
     */
    abstract public Object getReply() throws MessageException,
	    NotHandledException;
