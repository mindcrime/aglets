...
public class Message implements java.io.Serializable {
	...
	if ((obj instanceof Message) && ((Message) obj).sameKind(this.kind)) {
	    ...
	    if ((arg2 == this.arg)
		    || ((this.arg != null) && this.arg.equals(arg2))) {
		return true;
	    }
	}
	return false;
	...
	if (this.arg instanceof Hashtable) {
	    return ((Hashtable) this.arg).get(name);
	}
	return null;
    }
	...
	return ((m != null) && this.kind.equals(m.kind));
    }
	...
	if (this.arg instanceof Arguments) {
	    ((Arguments) this.arg).setArg(name, value);
	} else {
	...
	if (this.arg instanceof Arguments) {
	    ((Arguments) this.arg).setArg(name, a);
	} else {
	    throw new RuntimeException("Cannot set name-value pair");
	}
    }
