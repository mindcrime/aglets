...
/**
 * The <tt>MessageManager</tt> controls concurrency of incomming message. Each
 * kind of message can have a priority and will be placed in the message queue
...
public interface MessageManager {
    ...
    /**
     * Used as a argugment to the setPriority. It indicates that messages which
     * have the same kind will not be queued in the message queue and processed
     * immediately.
     * 
    ...
    /**
     * Used as a logical OR in the priority. It indicates that receiving this
     * kind of messages will automatically activate the aglet if it had been
     * deactivated.
     * 
     * <pre>
    ...
    /**
     * Stop accepting the messages public void close();
     */

    /**
     * Checks if the message queue is empty.
     * 
     * @return true if the message queue is empty. public boolean isEmpty();
     */

    /**
     * Destorys the manager. After this calling, the message manager is no
