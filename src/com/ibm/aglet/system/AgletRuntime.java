...
public abstract class AgletRuntime {
	 ...
	 * from a remote host, which means that the aglet can be dispatched
	 * into and also the remote operations like listing the aglet proxies
	 * residing in the context are enabled.
	 * @param cxt the context to export
	 * @exception SecurityException if the current execution is not allowed
	 * to export an AgletContext.
	 ...
	 * from a remote host, which means that the aglet can be receive
	 * remote messages from remote hosts.
	 * @param aglet the aglet to export
	 * @exception SecurityException if the current execution is not allowed
	 * to export an Aglet
	...
	/**
	 * Returns an enumeration of proxies in the context specified by
	 * the contextAddress.
	 * @param contextAddress
	 * abstract public Enumeration getAgletProxies(String contextAddress, String authorityName);
	 */
	/**
	 ...
	 */
	abstract public Certificate authenticateOwner(String username, 
			String password);
	/**
	 * Creates an aglet remotely within the specified context.
	 * 
	 * @param contextAddress an address of context.
	 * @param codebase an codebase for the aglet.
	 * @param name name of aglets' class.
	 * @param init an object passed as an initialize argument.
	 * @see Aglet#onCreation
	 * @see AgletContext#createAglet
	 */
	abstract protected AgletProxy createAglet(String contextAddress, 
											  URL codebase, String name, 
	 ...
	 * id.
	 * @param contextAddress specify context URL with a string.
	 * @param id target aglet identifyer.
	 */
	abstract protected AgletProxy getAgletProxy(String contextAddress, 
	 ...
	 * It needs PropertyPermission for the key of specified property,
	 * and FilePermission for the property file.
	 * @param prop name of properties
	 * @param key key of property
	 * @return property of the user who owns the runtime.
	 * If the property for the key does not exist, return null.
	 * @exception SecurityException if PropertyPermission for the key is not given.
	 */
	 ...
	 * @param prop name of properties
	 * @param key key of property
	 * @param def default value of property
	 * @return property of the user who owns the runtime.
	 * If the property for the key does not exist, return def.
	 * @exception SecurityException if PropertyPermission for the key is not given.
	 */
	...
	synchronized static public AgletRuntime init(String args[], 
		...
		try {
			packagePrefix = System.getProperty(runtimePackagePrefix, 
											   "com.ibm.aglets");
	 ...
	 * This is typically an argument of <tt>main(String args[])</tt> function.
	 * @param args arguments used to initialize
	 * @exception IllegalAccessException if the instance has
	 ...
	 * in this runtime.
	 * @param proxy the aglet proxy object to kill.
	 */
	 ...
	 * @param cxt the context to remove
	 */
	abstract public void removeAgletContext(AgletContext cxt);
	/**
	 * Sets aglets property of the user who owns the runtime.
	 * It needs PropertyPermission for the key of aglets property,
	 * and FilePermission for the aglets property file.
	 * @param key key of aglets property
	 * @param value value of specified aglets property
	 * @exception SecurityException if permissions for the key are not given.
	 */
	abstract public void setAgletsProperty(String key, String value);
	/**
	 * Save property of the user who owns the runtime.
	 * It needs PropertyPermission for the key of property,
	 * and FilePermission for the property file.
	 * @param prop name of properties
	 * @param key key of property
	...
	/**
	 * Sets secure.
	 * @param secure true if the runtime is working with security
	 */
