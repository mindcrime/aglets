...
/**
 * This class represnts a "translator" object for anything in the platform (even the platform
 * itself). Internally, this class uses a ResourceBundle object to provide the translation of contents.
...
public class AgletsTranslator implements Cloneable {
    ...
    /**
     * Builds this translator object with the specified resource name and locale.
     * @param localeBaseName the resource name (e.g., the name of properties file)
     * @param currentLocale the locale for which it is required the translation
     */
    ...
    /**
     * Translates a specific part of text, without arguments (i.e., you have to handle
     * escape characters outside this method). If the bundle has not been created or
     * if the text has no way to be translated (e.g., it is the string ""), then the original
    ...
    /**
     * Provides an implementation of the AgletsTranslator. If the translator has already been
     * loaded, the previous one is returned.
     * @param localeBaseName the base name for the translation
