...
public class GUICommandStrings {
    ...
    public static final String DISPATCH_AGLET_COMMAND = "_dispatch";
    public static final String RETRACT_AGLET_COMMAND = "_retract";
    public static final String DISPOSE_AGLET_COMMAND = "_dispose";
    public static final String ACTIVATE_AGLET_COMMAND = "_activate";
    public static final String DEACTIVATE_AGLET_COMMAND = "_deactivate";
    ...
    public static final String CONSOLE_COMMAND = "_console";
    ...
    public static final String IMPORT_SHARED_SECRET_COMMAND = "_importSharedSecret";
    public static final String EXPORT_SHARED_SECRET_COMMAND = "_exportSharedSecret";
    public static final String BROWSE_FILESYSTEM_COMMAND = "_browse";
    public static final String ADD_CODE_SOURCE_COMMAND = "_addCodeSource";
    public static final String REMOVE_CODE_SOURCE_COMMAND = "_removeCodeSource";
    public static final String ADD_PERMISSION_COMMAND = "_addPermission";
    public static final String REMOVE_PERMISSION_COMMAND = "_removePermissio";
