...
public interface OperationDescriptor extends GenericDescriptor{
	...
	/**
	 * Indicates the class type of the return type for this operation.
	 * It should be null if the isVoid() method returns true
	...
	/**
	 * Indicates which events will be sent due to the execution of this operation.
	 * @return the events that will be sent.
	 */
	public EventDescriptor[] getOutgoingEvents();
	
	/**
	 * Indicates which events could be received due to the execution of this operation.
	 * 
