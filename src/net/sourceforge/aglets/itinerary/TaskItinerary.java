...
/**
 * This interface defines an itinerary with task associated to each destination. Once the destination is reached
 * the related task is executed.
...
public interface TaskItinerary extends Itinerary {
	 ...
	 * <b>only on arrival</b> of an agent.
