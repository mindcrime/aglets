...
/**
 * This class represents a random itinerary, that is an itinerary which chose randomly the
 * next destination.
...
public class BaseRandomItinerary extends BaseItinerary {
	...
	/**
	 * Selects the next destination and goes to it. It is ensured that the next destination will be
	 * different from the current one, but not it will be different from the previous one!
	 */
