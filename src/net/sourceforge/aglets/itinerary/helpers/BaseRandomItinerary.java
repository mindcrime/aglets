...
public class BaseRandomItinerary extends BaseItinerary {
	 ...
	 */
	public BaseRandomItinerary(final Aglet owner) {
		super(owner);
	}
	...
	public void goToNextDestination() {
		...
		} while ((randomIndex < 0) || (randomIndex > destinations.size())
				|| (destinations.get(randomIndex) == null)
				|| (getCurrentIndex() == randomIndex));
