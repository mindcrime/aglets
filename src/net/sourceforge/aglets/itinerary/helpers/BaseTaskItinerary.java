...
Serializable, MobilityListener {
	...
	if ((toExecute == null)
		|| (toExecute.getExecutionType() != Task.EXECUTE_ON_DEFAULT)
		|| this.defaultTasks.isEmpty()
		|| (this.defaultTasks.contains(toExecute) == false))
	    return false;
	...
	ret.append("\texecute on arrival       = "
		+ this.executeDefaultTaskOnArrival);
	ret.append("\n\texecute on dispatch    = "
		+ this.executeDefaultTaskOnDispatch);
	ret.append("\n\texecute on revertering = "
		+ this.executedDefaultTaskOnReverting);
