...
public class AgletsLogger implements Cloneable {
	 ...
	 */
	public static AgletsLogger getLogger(final String name) {
	 ...
	 */
	private AgletsLogger(final String name) {
	 ...
	 * @since 1.0
	 */
	public void error(final Object msg, final Exception exc) {
	 ...
	 */
	public void translation(final String src, final String dest) {
		if ((src != null) || (dest != null))
			logger.debug("Translated/changed the string <<" + src
					+ ">> into <<" + dest + ">>");
	}
